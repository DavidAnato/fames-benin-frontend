...
const AuthRoutes = [
  ...
  <Route key="email-verification" path="/email-verification" Component={EmailValidateRequest} />,
  <Route key="active-email" path="/active-email" Component={ActiveEmail} />,
  <Route key="password-reset-request" path="/password-reset-request" Component={PasswordResetRequest} />,
  <Route key="password-reset-confirm" path="/password-reset-confirm" Component={PasswordResetConfirm} />,
  <Route key="set-password" path="/set-password" Component={SetPassword} />,
