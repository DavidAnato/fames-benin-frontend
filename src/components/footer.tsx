        ...
        <div className="flex flex-wrap justify-between gap-4">
          <div>
            ...
            <ul>
              ...
              <li><NavLink to="/success-story" className="link hover:text-gray-300">{t('footer.successStory')}</NavLink></li>
              <li><NavLink to="/library" className="link hover:text-gray-300">{t('footer.resources')}</NavLink></li>
            </ul>
          </div>
          <div>
